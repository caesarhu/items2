...
(def json-test-data
  {:item        {:items/file-time      (utils/file-time (fs/file json-file))
                 :items/ip             "0.0.0.0",
                 ...
                 :items/police         "大強子",
                 :items/memo           "這是全部備註"},
   :all-list    [{:all-list/item "高爾夫球桿", :all-list/quantity 1}
                 ...
                 {:all-list/item "Alprazolam(蝴蝶片)", :all-list/quantity 1}
                 {:all-list/item "滑板", :all-list/quantity 1}
                 {:all-list/item "鎂粉", :all-list/quantity 1}
                 {:all-list/item "管制先驅原料", :all-list/quantity 1}
                 {:all-list/item "Diazepam(安定、煩寧)", :all-list/quantity 1}
                 {:all-list/item "Lorazepam(一粒眠)", :all-list/quantity 1}
   ...
   :item-list   [{:item-list/kind    "危險物品",
                 ...
                 {:item-list/kind    "野保法",
                  :item-list/subkind nil,
                  :item-list/object  nil}],
   :item-people [{:item-people/kind   "危險物品",
